...
jade_debug.shift();
jade_debug.unshift({ lineno: 5, filename: "test/jade/mixins.jade" });
jade_debug.shift();
...
{
jade_debug.unshift({ lineno: 15, filename: "test/jade/mixins.jade" });
jade_debug.unshift({ lineno: 15, filename: "test/jade/mixins.jade" });
...
{
jade_debug.unshift({ lineno: 17, filename: "test/jade/mixins.jade" });
jade_debug.unshift({ lineno: 17, filename: "test/jade/mixins.jade" });
...
buf.push("<span>" + (jade.escape(null == (jade_interp = _t(_t(endString))) ? "" : jade_interp)));
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</span>");
jade_debug.shift();
...
jade_indent.pop();
jade_debug.shift();
jade_debug.unshift({ lineno: 20, filename: "test/jade/mixins.jade" });
jade_indent.push('');
