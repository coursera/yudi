...
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift({ lineno: 16, filename: "test/jade/simple.jade" });
buf.push("<span>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 17, filename: "test/jade/simple.jade" });
buf.push("!!!");
jade_debug.shift();
jade_debug.shift();
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift({ lineno: 18, filename: "test/jade/simple.jade" });
buf.push("<span>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 19, filename: "test/jade/simple.jade" });
buf.push("$100");
jade_debug.shift();
jade_debug.shift();
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift({ lineno: 20, filename: "test/jade/simple.jade" });
buf.push("<span>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 21, filename: "test/jade/simple.jade" });
buf.push("&nbsp;");
jade_debug.shift();
jade_debug.shift();
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift({ lineno: 22, filename: "test/jade/simple.jade" });
buf.push("<span>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 23, filename: "test/jade/simple.jade" });
buf.push("" + (((jade_interp = _t("&nbsp; look! there's a trailing space")) == null ? '' : jade_interp)) + " ");
jade_debug.shift();
jade_debug.shift();
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift({ lineno: 24, filename: "test/jade/simple.jade" });
buf.push("<span>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 25, filename: "test/jade/simple.jade" });
buf.push("" + (((jade_interp = _t("&nbsp; look! there's more space")) == null ? '' : jade_interp)) + "  ");
jade_debug.shift();
jade_debug.shift();
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift({ lineno: 26, filename: "test/jade/simple.jade" });
buf.push("<span>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 27, filename: "test/jade/simple.jade" });
buf.push("" + (((jade_interp = _t("&nbsp; look! there's a trailing space&nbsp;")) == null ? '' : jade_interp)) + "");
jade_debug.shift();
jade_debug.shift();
buf.push("</span>");
jade_debug.shift();
jade_debug.unshift({ lineno: 28, filename: "test/jade/simple.jade" });
buf.push("<span>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 29, filename: "test/jade/simple.jade" });
buf.push("" + (((jade_interp = _t("&nbsp; look! there's more space&nbsp;&nbsp;")) == null ? '' : jade_interp)) + "");
jade_debug.shift();
jade_debug.shift();
buf.push("</span>");
...
jade_debug.shift();}.call(this,"_t" in locals_for_with?locals_for_with._t:typeof _t!=="undefined"?_t:undefined,"complicated" in locals_for_with?locals_for_with.complicated:typeof complicated!=="undefined"?complicated:undefined,"interpolations" in locals_for_with?locals_for_with.interpolations:typeof interpolations!=="undefined"?interpolations:undefined,"javascript" in locals_for_with?locals_for_with.javascript:typeof javascript!=="undefined"?javascript:undefined,"onlyVar" in locals_for_with?locals_for_with.onlyVar:typeof onlyVar!=="undefined"?onlyVar:undefined,"strings" in locals_for_with?locals_for_with.strings:typeof strings!=="undefined"?strings:undefined));;return buf.join("");
  ...
  jade.rethrow(err, jade_debug[0].filename, jade_debug[0].lineno, "div\n  span\n    | #{_t(\"simple string detection\")}\n  span\n    | #{_t(\"strings with #{interpolations}\", {\"interpolations\":_t(interpolations)})}\n  span\n    | #{_t(\"#{strings} with multiple #{interpolations}\", {\"strings\":_t(strings), \"interpolations\":_t(interpolations)})}\n  span\n    | #{_t(\"strings with #{javascript.code()}\", {\"javascript.code()\":_t(javascript.code())})}\n  span\n    | #{_t(\"strings with #{complicated + javascript.code(\\\"with quoted strings\\\")}\", {\"complicated + javascript.code(\\\"with quoted strings\\\")\":_t(complicated + javascript.code(\"with quoted strings\"))})}\n  span\n    | #{_t(onlyVar)}\n  span\n    | 123\n  span\n    | !!!\n  span\n    | $100\n  span\n    | &nbsp;\n  span\n    | !{_t(\"&nbsp; look! there's a trailing space\")} \n  span\n    | !{_t(\"&nbsp; look! there's more space\")}  \n  span\n    | !{_t(\"&nbsp; look! there's a trailing space&nbsp;\")}\n  span\n    | !{_t(\"&nbsp; look! there's more space&nbsp;&nbsp;\")}");
}
}