...
buf.push("\n<p>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.unshift({ lineno: 4, filename: "test/jade/interpolation.jade" });
buf.push("" + (jade.escape((jade_interp = _t("#{test2} + #{test3}", {"test2":_t(test2), "test3":_t(test3)})) == null ? '' : jade_interp)) + "");
jade_debug.shift();
jade_debug.shift();
buf.push("</p>");
jade_debug.shift();
jade_debug.unshift({ lineno: 5, filename: "test/jade/interpolation.jade" });
buf.push("\n<p>" + (jade.escape(null == (jade_interp = _t(_t(test4))) ? "" : jade_interp)));
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</p>");
jade_debug.shift();
