...
buf.push("" + (jade.escape((jade_interp = hours) == null ? '' : jade_interp)) + "h " + (jade.escape((jade_interp = minutes) == null ? '' : jade_interp)) + "m");
jade_debug.shift();
jade_debug.shift();
}
else if ( minutes)
...
jade_debug.unshift({ lineno: 16, filename: "test/jade/mixins.jade" });
buf.push("" + (jade.escape((jade_interp = minutes) == null ? '' : jade_interp)) + " min");
jade_debug.shift();
jade_debug.shift();
}
else if ( seconds !== 0)
...
jade_debug.unshift({ lineno: 18, filename: "test/jade/mixins.jade" });
buf.push("" + (jade.escape((jade_interp = seconds) == null ? '' : jade_interp)) + " sec");
jade_debug.shift();
jade_debug.shift();
}
jade_debug.shift();
...
buf.push("<span>" + (jade.escape(null == (jade_interp = endString) ? "" : jade_interp)));
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
jade_debug.shift();
buf.push("</span>");
jade_debug.shift();
