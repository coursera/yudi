...
var jade_debug = [{ lineno: 1, filename: "extend.include.jade" }];
try {
var buf = [];
var jade_mixins = {};
var jade_interp;
...
buf.push("</h1>");
jade_debug.shift();
jade_debug.unshift({ lineno: 3, filename: "extend.include.jade" });
jade_debug.unshift({ lineno: 4, filename: "extend.include.jade" });
buf.push("\n<p>");
jade_debug.unshift({ lineno: undefined, filename: jade_debug[0].filename });
...
buf.push("</p>");
jade_debug.shift();
jade_debug.unshift({ lineno: 0, filename: "extend.include.jade" });
